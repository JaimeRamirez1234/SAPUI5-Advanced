		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employee",
									"targetURL": "#alfa02alfa02-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"alfa02alfa02-display": {
								"semanticObject": "alfa02alfa02",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=alfa02.alfa02",
									"url": sap.ui.require.toUrl("alfa02/alfa02")
								}
							}
						}
					}
